...
void defineServo() {
    int i, j;
    leg[0].servo[0].servoPin = 20;
    leg[0].servo[0].range[0] = 550.f;
    leg[0].servo[0].range[1] = 2400.f;    //Between 0-160 degree
    leg[0].servo[1].servoPin = 19;
    leg[0].servo[1].range[0] = 550.f;
    leg[0].servo[1].range[1] = 2400.f;
    leg[0].servo[2].servoPin = 18;
    leg[0].servo[2].range[0] = 550.f;
    leg[0].servo[2].range[1] = 2400.f;

    leg[1].servo[0].servoPin = 9;
    leg[1].servo[0].range[0] = 2400.f;
    leg[1].servo[0].range[1] = 550.f;
    leg[1].servo[1].servoPin = 10;
    leg[1].servo[1].range[0] = 2400.f;
    leg[1].servo[1].range[1] = 550.f;
    leg[1].servo[2].servoPin = 11;
    leg[1].servo[2].range[0] = 2400.f;
    leg[1].servo[2].range[1] = 550.f;    //Between 0-180

    leg[2].servo[0].servoPin = 28;
    leg[2].servo[0].range[0] = 2400.f;
    leg[2].servo[0].range[1] = 550.f;    //0-180
    leg[2].servo[1].servoPin = 22;
    leg[2].servo[1].range[0] = 2400.f;
    leg[2].servo[1].range[1] = 550.f;    //0-160
    leg[2].servo[2].servoPin = 21;
    leg[2].servo[2].range[0] = 2400.f;
    leg[2].servo[2].range[1] = 550.f;    //0-160

    leg[3].servo[0].servoPin = 0;
    leg[3].servo[0].range[0] = 550.f;
    leg[3].servo[0].range[1] = 2400.f;   //0-160
    leg[3].servo[1].servoPin = 1;
    leg[3].servo[1].range[0] = 550.f;
    leg[3].servo[1].range[1] = 2400.f;  //0-160
    leg[3].servo[2].servoPin = 8;
    leg[3].servo[2].range[0] = 550.f;
    leg[3].servo[2].range[1] = 2400.f;  //0-160
    for (i = 0; i < 4; i++)
        for (j = 0; j < 3; j++)
            leg[i].servo[j].init();
}
...
void moveBody(Eigen::Vector3f pos, int exception) {                       //Body displacement
    for (int i = 0; i < 4; i++) {
        if (i != exception) {
            leg[i].toPos(Eigen::Vector3f((1 - (i % 2) * 2) * pos(0), 40 - (1 - (i > 2) * 2) * pos(1), pos(2)));
        }
    }
...
void moveBody(Eigen::Vector3f pos) {                       //Body displacement
    Eigen::Vector3f translation(60,60,0);
    leg[0].toPos(translation + Eigen::Vector3f(-pos(0), + pos(1), pos(2)));
    leg[1].toPos(translation + Eigen::Vector3f(-pos(0), - pos(1), pos(2)));
    leg[2].toPos(translation + Eigen::Vector3f(+pos(0), + pos(1), pos(2)));
    leg[3].toPos(translation + Eigen::Vector3f(+pos(0), - pos(1), pos(2)));
}
/*
